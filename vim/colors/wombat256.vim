...
hi MPIn         ctermfg=208                     cterm=none
hi MPIb         ctermfg=208                     cterm=bold
hi OpenMPn      ctermfg=4                       cterm=none
hi OpenMPb      ctermfg=4                       cterm=bold
hi CUDAn        ctermfg=214		cterm=none
hi CUDAb        ctermfg=214		cterm=bold
hi LIBn         ctermfg=128             cterm=none
hi LIBb         ctermfg=128             cterm=bold
hi MACROn  	    ctermfg=160		cterm=none
hi MACROb   	ctermfg=160		cterm=bold
